...
// Test Configuration - Using non-standard ports to avoid conflicts with orphan node processes
const PROXY_PORT = 3140;
const TUNNEL_PORT = 8095;
const TARGET_PORT = 9010;

async function runTests() {
    console.log("Starting Deep Analysis Security Fixes Test Suite (V3 - Safe Ports)...");
    ...
    console.log("[...] Waiting for tunnel to stabilize (6s)...");
    ...
    try {
        ...
        await new Promise((resolve, reject) => {
            ...
            const timeout = setTimeout(() => {
                socket.destroy();
                reject(new Error("Test 1 Timeout - Possible connection issue or hang"));
            }, 10000);
